...
Object Storage Bucket에는 `index.html` 파일 하나만 업로드합니다.
...
```text
https://OBJECT_STORAGE_ORIGIN_URL/index.html
```
...
CDN Lab Console의 8단계에서 `현재 TTL 확인` 버튼을 누릅니다.
...
TTL이 지난 뒤 다시 요청하면 Nginx는 Origin에 다시 요청하거나 재검증을 수행합니다.
