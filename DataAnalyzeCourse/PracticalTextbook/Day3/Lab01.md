...
1. 카카오 클라우드 콘솔 > Beyond Networking Service > VPC > 보안 그룹
2. `보안 그룹 생성` 버튼 클릭
    - 보안 그룹
        - 새 보안 그룹 생성 클릭
            - 우측 상단의 `보안 그룹 생성` 버튼 클릭
                ...
                - `생성` 버튼 클릭
3. 카카오 클라우드 콘솔 > Container Pack > Kubernetes Engine > 클러스터
4. 생성된 `k8s-cluster` 클릭
5. 생성된 k8s-cluster 세부 정보 확인

#### pool-ingress 노드풀 생성 (약 3분 소요)
6. 노드 풀 탭 > 노드 풀 생성 버튼 클릭
7. pool-ingress 노드 풀 설정 정보
...
8. 노드 풀 탭 > 노드 풀 생성 버튼 클릭
9. pool-worker 노드 설정 정보
    - 노드 풀 유형: `Virtual Machine`
    - 기본 설정
        - 노드 풀 이름: `pool-worker`
        - 노드 풀 설명(선택): `빈 칸`
...
10. 노드 풀 탭 > 노드 풀 생성 버튼 클릭
11. pool-worker 노드 설정 정보
    - 노드 풀 유형: `GPU`
    - 기본 설정
        - 노드 풀 이름: `pool-gpu`
        - 노드 풀 설명(선택): 빈칸
    ...
    - 고급 설정(선택): `빈 칸`
    - `생성` 버튼 클릭
12. 노드 풀 탭에서 생성된 노드 풀 목록 확인
    - pool-ingress, pool-worker, pool-gpu 생성 확인
13. 노드 탭 클릭 후 노드 8개 생성 확인
