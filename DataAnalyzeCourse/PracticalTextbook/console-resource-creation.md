...
- **리스너**
    - **프로토콜**: `HTTP`, **포트**: `80`
- `생성` 버튼 클릭
- 로드 밸런서 프로비저닝 상태: Active, 운영 상태: Online 확인 후 `Public IP 연결`
...
### test-topic의 Push Subscription

- **기본 설정**
    - **이름**: `test-top-push-sub`
    - **토픽 선택**: `test-topic`
- **유형**: `Push`
    - **엔드포인트**: `http://`, `ALB Public IP`
- **서브스크립션 메시지 보존 기간:** `1일`
- **응답 대기 시간**: `20초`
- **재처리 횟수**: `횟수 지정`, `3번`
