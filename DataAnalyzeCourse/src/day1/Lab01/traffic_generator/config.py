...
PARETO_CONFIG = config['threads']['pareto_distribution']
RETURNING_USER_PROBABILITY = config['threads']['returning_user_probability']
...
# 플래시 세일 설정
FLASH_SALE_CONFIG = config.get('flash_sale', {})
...
STATE_TRANSITIONS = {
    "Anon_NotRegistered": {
        "Anon_NotRegistered": 0.3, "Anon_Registered": 0.5, "Done": 0.2
    },
    "Anon_Registered": {
        "Anon_Registered": 0.3, "Logged_In": 0.5, "Unregistered": 0.1, "Done": 0.1
    },
    "Logged_In": {
        "Logged_In": 0.7, "Logged_Out": 0.1, "Unregistered": 0.1, "Done": 0.1
    },
    "Logged_Out": {
        "Unregistered": 0.1, "Anon_Registered": 0.1, "Done": 0.8
    },
    "Unregistered": {"Done": 1.0},
    "Done": {}
}
...
ANON_SUB_TRANSITIONS = {
    "Anon_Sub_Initial": {"Anon_Sub_Main": 1.0},
    "Anon_Sub_Main": {
        "Anon_Sub_Products": 0.4, "Anon_Sub_Search": 0.3, "Anon_Sub_Categories": 0.2, "Anon_Sub_Done": 0.1
    },
    "Anon_Sub_Products": {
        "Anon_Sub_ViewProduct": 0.5, "Anon_Sub_Main": 0.3, "Anon_Sub_Done": 0.2
    },
    "Anon_Sub_ViewProduct": {
        "Anon_Sub_Products": 0.5, "Anon_Sub_Done": 0.5
    },
    "Anon_Sub_Categories": {
        "Anon_Sub_CategoryList": 0.6, "Anon_Sub_Main": 0.4
    },
    "Anon_Sub_CategoryList": {
        "Anon_Sub_Products": 0.7, "Anon_Sub_Done": 0.3
    },
    "Anon_Sub_Search": {
        "Anon_Sub_ViewProduct": 0.6, "Anon_Sub_Done": 0.4
    },
    "Anon_Sub_Done": {}
}
...
LOGGED_SUB_TRANSITIONS = {
    "Login_Sub_Initial": {"Login_Sub_Main": 1.0},
    "Login_Sub_Main": {
        "Login_Sub_Products": 0.3, "Login_Sub_ViewProduct": 0.2, "Login_Sub_Search": 0.1, "Login_Sub_ViewCart": 0.2, "Login_Sub_CheckoutHistory": 0.1, "Login_Sub_Done": 0.1
    },
    "Login_Sub_Products": {
        "Login_Sub_ViewProduct": 0.6, "Login_Sub_Main": 0.2, "Login_Sub_Done": 0.2
    },
    "Login_Sub_ViewProduct": {
        "Login_Sub_CartAdd": 0.7, "Login_Sub_Products": 0.2, "Login_Sub_Done": 0.1
    },
    "Login_Sub_Search": {
        "Login_Sub_ViewProduct": 0.8, "Login_Sub_Done": 0.2
    },
    "Login_Sub_ViewCart": {
        "Login_Sub_Checkout": 0.6, "Login_Sub_CartRemove": 0.2, "Login_Sub_Main": 0.2
    },
    "Login_Sub_CheckoutHistory": {
        "Login_Sub_Main": 0.8, "Login_Sub_Done": 0.2
    },
    "Login_Sub_CartAdd": {
        "Login_Sub_ViewCart": 0.5, "Login_Sub_Products": 0.3, "Login_Sub_Done": 0.2
    },
    "Login_Sub_CartRemove": {
        "Login_Sub_ViewCart": 0.8, "Login_Sub_Done": 0.2
    },
    "Login_Sub_Checkout": {
        "Login_Sub_AddReview": 0.5, "Login_Sub_Main": 0.3, "Login_Sub_Done": 0.2
    },
    "Login_Sub_AddReview": {
        "Login_Sub_Main": 0.7, "Login_Sub_Done": 0.3
    },
    "Login_Sub_Done": {}
}
...
TIME_SEGMENTS = {name: (seg['start'], seg['end']) for name, seg in _TIME_SEGMENTS_RAW.items()}
SEGMENT_FACTORS = {name: tuple(seg['factor_range']) for name, seg in _TIME_SEGMENTS_RAW.items()}
