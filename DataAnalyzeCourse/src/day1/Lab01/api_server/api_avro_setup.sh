...
sudo cp /home/ubuntu/tutorial/DataAnalyzeCourse/src/day1/Lab01/api_server/nginx.avsc /etc/logstash/schema/nginx.avsc || {
    echo "kakaocloud: nginx.avsc 복사 실패"; exit 1;
}
