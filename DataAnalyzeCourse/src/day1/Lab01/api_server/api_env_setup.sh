...
export CREDENTIAL_ID CREDENTIAL_SECRET DOMAIN_ID PROJECT_ID TOPIC_NAME_PUBSUB KAFKA_TOPIC_NAME MYSQL_HOST SCHEMA_REGISTRY_URL LOGSTASH_KAFKA_ENDPOINT ENABLE_KAFKA_OUTPUT
EOF
