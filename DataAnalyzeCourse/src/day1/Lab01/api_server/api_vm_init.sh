...
export ENV_SETUP_SCRIPT_URL="https://github.com/kakaocloud-edu/tutorial/raw/refs/heads/tg_lsh_per/DataAnalyzeCourse/src/day1/Lab01/api_server/api_env_setup.sh"
