...
export OBJECT_STORAGE_SUBSCRIPTION_NAME="{생성할 Object Storage Subscription 이름(log-topic-push-sub)}"
export OBJECT_STORAGE_BUCKET="{Pub/Sub NGINX 로그 저장용 버킷(pubsub-nginx-log)}"
