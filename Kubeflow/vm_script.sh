...
echo "kakaocloud: Docker 설치 완료"

echo "kakaocloud: 3. kubectl 설치"
# kubectl 설치
curl -LO "https://dl.k8s.io/release/$(curl -L -s https://dl.k8s.io/release/stable.txt)/bin/linux/amd64/kubectl"
sudo install -o root -g root -m 0755 kubectl /usr/local/bin/kubectl
echo "kakaocloud: kubectl 설치 완료"

echo "kakaocloud: 4. kic-iam-auth 설치"
# kic-iam-auth 설치
...
echo "kakaocloud: 5. kube config 설정"
# kube config 설정
...
echo "kakaocloud: 6. 하이퍼파라미터에 필요한 파일 다운로드"
