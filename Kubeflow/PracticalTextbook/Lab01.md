...
1. 사용자 이메일의 초대받은 메일의 `비밀번호 등록하기` 클릭
    - 초기 비밀번호: 원하는 비밀번호 입력
        - 영어 대·소문자, 특수문자, 숫자 조합, 9~30자
    - 비밀번호 재입력: 초기 비밀번호에서 입력한 비밀번호와 동일한 비밀번호 재입력
    - `비밀번호 등록` 클릭
3. 콘솔 로그인
    - 조직이름: kakaocloud-edu 입력
    - `다음` 클릭
    - 클라우드 계정: 로그인 정보 입력
    - 비밀번호: 앞에서 등록한 비밀번호 입력
    - `콘솔 로그인` 버튼 클릭
...
5. 액세스 키 설정 정보 작성
     ...
     - 만료 기한 : `지정하지 않음` 선택
     - `생성` 버튼 클릭
6. 사용자 액세스 키 ID 복사 후 메모장에 붙여넣기
7. 사용자 액세스 보안 키 복사 후 메모장에 붙여넣기
