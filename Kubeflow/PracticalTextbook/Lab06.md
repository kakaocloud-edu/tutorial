...
9. cloud-init log 확인하는 명령어 입력사용자 스크립트를 통해 미리 준비해둔 하이퍼파라미터 실습 파일 조회
...
1. 하이퍼파라미터 파일 다운로드 확인
   ...
   ```
2. kubectl get nodes를 통해 생성했던 노드들 조회
   #### **lab6-3-2**
   ```bash
   kubectl get nodes
   ```
