...
1. VM 생성 전 스크립트 작성
   ...
   # kic-iam-auth 설치
   sudo wget -O /usr/local/bin/kic-iam-auth https://objectstorage.kr-central-2.kakaocloud.com/v1/c11fcba415bd4314b595db954e4d4422/public/docs/binaries-kic-iam-auth/Linux%20x86_64%2064Bit/kic-iam-auth
         ...
         spec:
           template:
             ...
             spec:
               containers:
                 - name: mnist-training
                   image: {프로젝트 이름}.kr-central-2.kcr.dev/kakao-registry/hyperparam:1.0
                   command:
                     - "python"
                     - "mnist_train.py"
...
2. ${프로젝트 이름}을 카카오클라우드 콘솔 왼쪽 상단에 있는 프로젝트 이름으로 대체
