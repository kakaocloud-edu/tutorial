...
curl --output /dev/null --silent --head --fail "https://github.com/kakaocloud-edu/tutorial/raw/main/AdvancedCourse/src/script/script5.sh" || { echo "kakaocloud: script download site is not valid"; exit 1; }
echo "kakaocloud: script download site is valid"


wget https://github.com/kakaocloud-edu/tutorial/raw/main/AdvancedCourse/src/script/script5.sh
chmod +x script5.sh
sudo -E ./script5.sh
   ```
