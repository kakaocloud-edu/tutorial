...
6. 사용자 스크립트 작성
   ...
   echo "kakaocloud: Starting environment variable setup"
...
13. Outbound 클릭
    ...
    - 만들기 버튼 클릭
14. 고급설정 버튼 클릭
    - 사용자 스크립트에 [**lab3-1-6**](https://github.com/kakaocloud-edu/tutorial/blob/main/AdvancedCourse/PracticalTextbook/Lab03.md?plain=1#L34) 내용을 붙여넣기
