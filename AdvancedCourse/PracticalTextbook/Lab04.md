...
3. 생성한 이미지 태그하기
   ...
   #### **lab4-4-3**
   ```
   docker tag demo-spring-boot kakaocloud.kr-central-2.kcr.dev/k8s-registry/demo-spring-boot:latest
   ```
...
7. 이미지 업로드하기
   ...
   #### **lab4-4-7**
   ```
   docker push {프로젝트 이름}.kr-central-2.kcr.dev/k8s-registry/demo-spring-boot:latest
   ```
