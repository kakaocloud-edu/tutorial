...
echo "kakaocloud: 2.Preparing directories and files"
...
echo "kakaocloud: 3.Downloading YAML files"
...
echo "kakaocloud: 4.Installing kubectl"
...
echo "kakaocloud: 5.Setting up .kube directory and configuration file"
...
echo "kakaocloud: 6.Installing kic-iam-auth"
...
echo "kakaocloud: 7.Installing Docker and setting it up"
...
echo "kakaocloud: 8.Installing additional software"
...
echo "kakaocloud: 9.Setting permissions for .kube/config"
...
echo "kakaocloud: 10.Downloading helm-values.yaml and applying environment substitutions"
