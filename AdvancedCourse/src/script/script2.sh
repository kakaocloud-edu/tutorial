...
sudo chmod -R +x /home/ubuntu/spring/ || { echo "kakaocloud: Failed to change permission of mvnw"; exit 1; }
...
echo "kakaocloud: 11.Setting .kube/config"
...
echo "kakaocloud: 13.Checking Kubernetes cluster nodes status"
